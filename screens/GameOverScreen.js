      ...
      <View style={styles.container}>
        ...
        <View style={styles.imageContainer}>
          <Image
            fadeDuration={1000}
            style={styles.image}
            // source={require("../assets/success.png")} for localimages
            source={{
              uri:
        ...
        <View style={styles.resultContainer}>
          ...
          <BodyText>
            Number was <Text style={styles.highlight}> {props.userChoice}</Text>
          </BodyText>
        </View>
        <MyMainButton onPress={props.configureNewGameHandler}>
          New Game
        </MyMainButton>
      </View>
    </ScrollView>
